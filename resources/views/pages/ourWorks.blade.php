...
<section class="image-gallery-area section-gap">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 single-gallery">
                <a href="{{ asset('images/եռդ.jpg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/եռդ.jpg') }}" alt=""></a>
                <a href="{{ asset('images/եֆե.jpg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/եֆե.jpg') }}" alt=""></a>
            </div>
            <div class="col-lg-4 single-gallery">
                <a href="{{ asset('images/ռնքա.jpg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/ռնքա.jpg') }}" alt=""></a>
                <a href="{{ asset('images/daspas.jpg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/daspas.jpg') }}" alt=""></a>
            </div>

            <div class="col-lg-4 single-gallery">
                <a href="{{ asset('images/daspas-1.jpeg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/daspas-1.jpeg') }}" alt=""></a>
                <a href="{{ asset('images/daspas-2.jpeg') }}" class="img-gal"><img class="img-fluid" src="{{ asset('images/daspas-2.jpeg') }}" alt=""></a>
            </div>
            <div class="col-lg-4 single-gallery">
